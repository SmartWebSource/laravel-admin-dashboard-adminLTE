      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Resume List</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Add New Resume</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Upload Resume</a></li>
          </ul>
        </li>
      </ul>
    </section>
